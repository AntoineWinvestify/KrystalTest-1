...
*/
    ...
    35 => [
        ...
        48 => [
                ...
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
                "function" => "calculatePlatformRecoveries",
                "cashflowOperation" => "bcadd"    
            ],
        ...
        68 => [
                ...
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
                "function" => "calculateCurrencyFluctation",  
                "cashflowOperation" => "bcadd"    
            ],
        69 => [ 
        ...
        72 => [ 
                "databaseName" => "globalcashflowdata.globalcashflowdata_platformCompensationPositive",  
                "internalName" => "globalcashflowdata_platformCompensationPositive",     
                "internalIndex" => 72,            
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
        ...
        76 => [
                "databaseName" => "Userinvestmentdata.userinvestmentdata_defaultInterestIncome",  
        ...
        81 => [ 
                "databaseName" => "globalcashflowdata.globalcashflowdata_platformCompensationNegative",  
                "internalName" => "globalcashflowdata_platformCompensationNegative",     
                "internalIndex" => 81,            
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
                "function" => "calculatePlatformCompensationNegative" ,
                "cashflowOperation" => "bcadd" 
            ],
        82 => [ 
        ...
        85 => [  //OK ok
                "databaseName" => "payment.payment_tempCamp2", 
                "globalDatabaseName" => "globalcashflowdata.globalcashflowdata_regularGrossInterestIncome",
                "internalName" => "payment_regularGrossInterestCost",             
                "internalIndex" => 85,            
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
                "function" => "calculateRegularGrossInterestCost",           
                "cashflowOperation" => "bcsub" 
            ], 
        86 => [    //OK ok 
                "databaseName" => "payment.payment_tempCamp",  
                "internalName" => "payment_capitalRepaymentCost",         
                "internalIndex" => 86,            
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
                "function" => "calculateCapitalRepaymentCost",           
                "cashflowOperation" => "bcsub",
            ],
        87 => [
...
/*
 * are these 2 concepts related to loanId (I guess so) 
 * ASK OLENA, these look like "normal investments but with funds coming from another currency?)
        82 => [ 
                ...
                "state" => WIN_FLOWDATA_VARIABLE_NOT_DONE,
                "charAcc" => WIN_FLOWDATA_VARIABLE_ACCUMULATIVE,   
                "function" => "calculatePlatformCompensation" ,
                "cashflowOperation" => "bcadd" 
            ],    
        83 => [ 
