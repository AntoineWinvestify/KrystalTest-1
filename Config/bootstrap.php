...
//Configure::load('parser');          // loads the xls/csv file parser  
...
//$investmentListener->getEventManager()->attach(new GlobalEmailListener());
 ...
 App::uses('PollingresourceListener', 'Event'); 
 CakeEventManager::instance()->attach(new PollingresourceListener());          
  
  
 App::uses('LinkedaccountListener', 'Event'); 
 CakeEventManager::instance()->attach(new LinkedaccountListener());   
...
// copied from https://www.dereuromark.de/2012/08/06/namespaces-in-vendor-files-and-cake2-x/
