...
$config['alias'] = array(
        ...
        'Role/2' => 'Role/winAdmin',
        'Role/3' => 'Role/PFPAdmin',
	'Role/4' => 'Role/investor',
);

/**
 * role configuration
 * This config is used to get the heritage for Roles
 * For example, all Role must heritage 
 * Any role not in this array will get 'Role/default'
 */
$config['roles'] = array(
	//'Role/admin' => null,
        'Role/investor' => 'Role/default',
        'Role/winAdmin' => 'Role/default',
        'Role/PFPAdmin' => 'Role/default',
        'Role/superAdmin' => 'Role/default'
);

/**
 * rule configuration
 * Role/default is the user when doesn't have a role
 */
$config['rules'] = array(
    'allow' => array(
        //'*' => 'Role/winAdmin',
        '*' => 'Role/superAdmin',
        'pages/*' => 'Role/default',
        'marketplaces/getGlobalMarketPlaceData' => 'Role/default',
        'contactforms/*' => 'Role/default',
        'users/*' => 'Role/default',
        'notifications/*' => 'Role/default',
        'plugins/*' => 'Role/default',
        'fonts/*' => 'Role/default',
        'img/*' => 'Role/default',
        //
        'marketplaces/*' => 'Role/investor',
        'dashboards/*' => 'Role/investor',
        'dashboard2s/*' => 'Role/investor',
        ...
        //ROLE INVESTOR:
        'ocrs/activatedService' => "Role/investor",
        'ocrs/ocrCompletedProcess' => "Role/investor",
        'ocrs/ocrInvestorConfirmModal' => "Role/investor",
        'ocrs/ocrInvestorDataPanel' => "Role/investor",
        'ocrs/ocrInvestorPlatformSelection' => "Role/investor",
        'ocrs/ocrInvestorView' => "Role/investor",
        'ocrs/oneClickInvestorI' => "Role/investor",
        'ocrs/oneClickInvestorII' => "Role/investor",
        'ocrs/companyFilter' => "Role/investor",
        'ocrs/deleteCompanyOcr' => "Role/investor",
        'ocrs/deleteCompanyOcrAll' => "Role/investor",
        'ocrs/resetInvestorDemo' => "Role/investor",
        'files/delete' => "Role/investor",
        'files/deleteAll' => "Role/investor",
        'files/upload' => "Role/investor",
        'dashboard2s/showInitialPanel' => 'Role/investor',
        'dashboard2s/dashboardOverview' => 'Role/investor',
        
        //ROLE PFPADMIN:
        'ocrs/isChargeableEvent' => 'Role/PFPAdmin',
        'ocrs/ocrPfpBillingPanel' => 'Role/PFPAdmin',
        'ocrs/ocrPfpUsersPanel' => 'Role/PFPAdmin',
        'ocrs/ocrPfpTallyman' => 'Role/PFPAdmin',
        'ocrs/readtallymandata' => 'Role/PFPAdmin',
        'ocrs/showTallymanPanel' => 'Role/PFPAdmin',
        'ocrs/startTallyman' => 'Role/PFPAdmin',
        'ocrs/uploadStatusInvestorPfp' => 'Role/PFPAdmin',
        'files/download' => 'Role/PFPAdmin',
        'files/downloadDocument' => 'Role/PFPAdmin',
        'files/generateZip' => 'Role/PFPAdmin',
        
        //ROLE WINADMIN:
        'ocrs/ocrWinadminInvestorChecking' => 'Role/winAdmin',
        'ocrs/ocrWinadminInvestorData' => 'Role/winAdmin',
        'ocrs/ocrWinadminBillingPanel' => 'Role/winAdmin',
        'ocrs/billsTable' => 'Role/winAdmin',
        'ocrs/updateChecks' => 'Role/winAdmin',
        'ocrs/ocrWinadminInvestorChecking' => 'Role/winAdmin',
        'ocrs/ocrWinadminUpdatePfpdata' => 'Role/winAdmin',
        'ocrs/updateCompanyOcrData' => 'Role/winAdmin',
        'ocrs/ocrWinadminSoldUsers' => 'Role/winAdmin',
        'ocrs/ocrWinadminTallyman' => 'Role/winAdmin',
        'ocrs/generateExcel' => 'Role/winAdmin',
        'files/uploadWinadmin' => 'Role/winAdmin',
        'files/downloadDocumentWinadmin' => 'Role/winAdmin',
        'files/downloadWinadmin' => 'Role/winAdmin',
        //'O/*' => 'Role/investor',
        
    ),
    'deny' => array(
        //'MarketplacesController/cronQueueEvent' => 'Role/investor'
        //'DashboardsController/getDashboardData'=> 'Role/investor',
        //'*' => 'Role/investor'
        //'DashboardsController/*'=> 'Role/investor'
        //'*' => 'Role/default'
    ),
);
