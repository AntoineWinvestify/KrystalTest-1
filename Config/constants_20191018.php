...
define('WIN_JWT_DURATION', 29960000);                                               // Duration of the JWT for API clients
...
define('WIN_QUEUE_STATUS_START_CONSOLIDATION', 10);
define('WIN_QUEUE_STATUS_CONSOLIDATION_FINISHED', 11);
define('WIN_QUEUE_STATUS_STARTING_CALCULATION_CONSOLIDATION', 12);
define('WIN_QUEUE_STATUS_CALCULATION_CONSOLIDATION_FINISHED', 13);
...
define('WIN_PAYMENTFREQUENCY_ONEPAYMENT', 7); 
...
define('GLOBALDASHBOARD_RESERVED_FUNDS', 1);
...
define('GLOBALDASHBOARD_NET_RETURNS', 10);
...
define('DASHBOARD_LAST_365_DAYS', 22);
define('DASHBOARD_LAST_YEAR', 23);
define('DASHBOARD_TOTAL_FUNDS', 24);
