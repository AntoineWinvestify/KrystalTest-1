                ...
                <td bgcolor="#ffffff">
					...
					<?php
						$options = array ("width"	=> "600",
											"height" => "",
											"alt"	=> "Winvestify textLogo" ,
											"border" => "0",
											"align"	=> "center",
											"style"	=> "z-index: 10; width: 100%; max-width: 600px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;",
											"class"	=> "g-img"
										  );
						echo $this->Html->image(Router::fullbaseUrl() . DS . APP_DIR . DS . WEBROOT_DIR . '/megaKit/img/1200x600/01.png', $options);
					?>
        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 30px 10px;width: 100%;font-size: 12px; font-family: sans-serif; line-height:18px; text-align: justify; color: #888888;" class="x-gmail-data-detectors">
                    ...
                    <?php //echo __('Este mensaje y sus ficheros adjuntos tienen carácter privado y confidencial y van dirigidos exclusivamente a sus destinatarios.
			//				 Si ha recibido este mensaje por error, no debe revelarlo, copiarlo o distribuirlo en ningún sentido sin previo consentimiento
			//				 por escrito de Winvestify Asset Management. Rogamos lo comunique al remitente y elimine dicho mensaje y cualquier documento
			//				 adjunto que pudiera contener. De no hacerlo así puede vulnerar la legislación vigente.')
                    ?>
