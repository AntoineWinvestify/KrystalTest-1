                ...
                <table id="activeInvestmentTable" class="investmentDetails table striped display" width="100%" cellspacing="0" data-page-length='25'>
                    <thead>
                        <tr>
                            ...
                            <th><i data-toggle="tooltip" data-placement="top" title="<?php echo __('Indicates the number of days of payment delay.') ?>" class="ion ion-ios-information-outline" ></i> <?php echo __('Status') ?></th>
                        </tr>
                    </thead>
                    <tbody>
