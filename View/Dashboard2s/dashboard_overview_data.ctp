                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="card card-stats">
                                        <div class="card-content">
                                            ...
                                            <h3 class="title"><?php echo number_format(round(bcmul(bcdiv($total, $overviewNet['Dashboardoverviewdata']['dashboardoverviewdata_netAnnualReturnPast12Months'],16), 100, 16), WIN_SHOW_DECIMAL, PHP_ROUND_HALF_UP), WIN_SHOW_DECIMAL) . "%"?></h3>
                                        </div>
                                        <div class="card-footer">
                                            <table id="box2Table" class="table" width="100%" cellspacing="0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="right"><?php echo number_format(round(bcmul(bcdiv($total, $overviewNet['Dashboardoverviewdata']['dashboardoverviewdata_netAnnualTotalFundsReturn'],16), 100, 16), WIN_SHOW_DECIMAL, PHP_ROUND_HALF_UP), WIN_SHOW_DECIMAL) . "%"?></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="right"><?php echo number_format(round(bcmul(bcdiv($total, $overviewNet['Dashboardoverviewdata']['dashboardoverviewdata_netAnnualReturnPast12Months'],16), 100, 16), WIN_SHOW_DECIMAL, PHP_ROUND_HALF_UP), WIN_SHOW_DECIMAL) . "%"?></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="right"><?php echo number_format(round(bcmul(bcdiv($total, $overviewNet['Dashboardoverviewdata']['dashboardoverviewdata_netAnnualReturnPastYear'],16), 100, 16), WIN_SHOW_DECIMAL, PHP_ROUND_HALF_UP), WIN_SHOW_DECIMAL) . "%"?></td>
                                                    </tr>
                                                    <tr><td colspan="2"><hr width="90%" class="no-padding"/></td></tr>
                                                    <tr>
                                                        <td class="left">
                                                        ...
                                                        <td class="right"><?php echo number_format(round(bcmul(bcdiv($total, $overviewNet['Dashboardoverviewdata']['dashboardoverviewdata_netReturnPast12Months'],16), 100, 16), WIN_SHOW_DECIMAL, PHP_ROUND_HALF_UP), WIN_SHOW_DECIMAL) . "%"?></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="right"><?php echo number_format(round(bcmul(bcdiv($total, $overviewNet['Dashboardoverviewdata']['dashboardoverviewdata_netReturnPastYear'],16), 100, 16), WIN_SHOW_DECIMAL, PHP_ROUND_HALF_UP), WIN_SHOW_DECIMAL) . "%"?></td>
                                                    </tr>
                                                    <tr><td colspan="2"><hr width="90%" class="no-padding"/></td></tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table id="box3Table" class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="right"><?php echo number_format( round($global['writtenOff'], WIN_SHOW_DECIMAL), WIN_SHOW_DECIMAL)  . " &euro;";?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
