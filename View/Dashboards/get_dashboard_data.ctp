 ...
 *
  ...
  2017/4/26
  Amorticed investments fixed.

  2017/4/27
  Active investment 0 error fixed
...
if ($noAccountsLinked == true) {
    ...
    <div class="dashboard">
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-win1">
                    <div class="inner" data-toggle="tooltip" data-placement="auto" title="<?php echo __('Amount of money currently invested') ?>">
                        <h3><?php echo number_format((float) $dashboardGlobals['amountInvested'] / 100, 2, ',', '') ?>&euro;</h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-win3" data-toggle="tooltip" data-placement="auto" title="<?php echo __('Amount of money in all your Wallets') ?>">
                    <div class="inner">
                        <h3><?php echo number_format((float) $dashboardGlobals['wallet'] / 100, 2, ',', '') ?>&euro;</h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-win5" data-toggle="tooltip" data-placement="auto" title="<?php echo __('The average profitibility of all your active investments') ?>">
                    <div class="inner">
                        <h3><?php echo number_format((float) $dashboardGlobals['meanProfitibility'] / 100, 2, ',', '') ?>&#37;</h3>
        ...
        <?php echo number_format((float) $companyGlobal['global']['myWallet'] / 100, 2, ',', '') . " &euro;"; ?></h4>
                                    </div>
                                    <!-- /.description-block 1 -->
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-2 col-xs-6">
                                    <div class="description-block border-right">
                                        ...
                                        <h4 class="description-header">
        <?php echo number_format((float) $companyGlobal['global']['profitibility'] / 100, 2, ',', '') . "  &#37;"; ?></h4>
                                    </div>
                                    <!-- /.description-block 2 -->
                                </div> <!-- /col -->
                                <div class="col-sm-2 col-xs-6">
                                    <div class="description-block border-right">
                                        ...
                                        <h4 class="description-header">
        <?php echo number_format((float) $companyGlobal['global']['totalInvestment'] / 100, 2, ',', '') . " &euro;"; ?></h4>
                                ...
                                <div class="col-sm-2 col-xs-6">
                                    <div class="description-block">
                                        ...
                                        <h4 class="description-header">
        <?php echo number_format((float) $companyGlobal['global']['activeInInvestments'] / 100, 2, ',', '') . " &euro;"; ?></h4>
