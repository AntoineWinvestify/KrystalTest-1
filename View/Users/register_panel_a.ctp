                                    ...
                                    <div class="col-sm-offset-1 col-sm-10">
                                        <div class="form-group">
											...
											<?php
												...
												$class = "form-control blue_noborder center-block userName". ' ' . $errorClass;
                                    ...
                                    <div class="col-sm-offset-1 col-sm-10">
                                        <div class="form-group">
											...
											<?php
												...
												$class = "form-control blue_noborder center-block password1". ' ' . $errorClass;
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group">
											...
											<?php
												...
												$class = "form-control blue_noborder center-block password2". ' ' . $errorClass;
