...
//Automatic feedback
            ...
            <div id="platformSelection" class="row">
                ...
                foreach ($company as $company) {
                    ?>
                    <span class="company">
                        <div id ="<?php echo $company['Company']['id'] ?>" class="companyDiv col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="box-footer no-padding">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
                                            <button class="btnSelect btn btn-default btn-win2 btnMargin center-block btnSelectedPlatform" href = "#"><?php echo __('Select') ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
