...
<?php /*<div class="editDatosPersonales" style="display:none;">
    <div class="box-body">
        <div class="row">
...
<?php
	...
	<div class="row" id="passwordTooltip1" style="display:none">
...
?>
                    ...
                    <div class="form-control blue">
											<?php
												...
												echo $this->Form->input('Investor.investor_telephone', array(
																		'name'			=> 'telephone',
																		'id' 			=> 'ContentPlaceHolder_telephone11',
																		'label' 		=> false,
		...
		<div class="form-group">
			...
			<div class="input-group input-group-sm blue date">
                            ...
                            <input type="text" style="border-radius:8px; border:none;" class="<?php echo $class ?>" name="dateOfBirth" placeholder="<?php echo __('Date of Birth')?>" id="ContentPlaceHolder_dateOfBirth22" value="<?php echo $resultUserData[0]['Investor']['investor_dateOfBirth'] ?>">
			</div>
		</div>
            </div>
	</div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header" data-background-color="blue">
                    <h4 class="title"><?php echo __('Personal Data')?></h4>
                </div>
            ...
            ?>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4"> <!-- date picker -->
                            <div class="form-group">
                                <label for="ContentPlaceHolder_dateOfBirth"><?php echo __('Date of Birth')?></label>
