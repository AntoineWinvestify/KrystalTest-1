                    ...
                    <div class="tab-pane" id="account">
                        <ul style="list-style-type: none;">
                            ...
                            <div id="answer_a3_1" style="display:none">
                                <?php echo __('La seguridad está garantizada. Para Winvestify su comunidad de inversores es lo más valioso y por tanto aplicamos todas la medidas técnicas para proteger los datos de sus inversores. Toda las comunicaciones entre las plataformas de crowdlending y nuestros servidores están cifradas con los máximos niveles de encriptación, 256 bits, como realizan los bancos en sus operativas. La información es almacenada en soportes de información con sistemas de cifrado, de forma disociada que la convierte en inútil en caso de no disponer de todos los componentes de la misma.')?><br/>
                                <?php echo __('Para más detalle, ponemos a tu disposición nuestra política de protección de datos para que puedas consultarla y resolver cualquier duda que te haya quedado.')?>
                            </div>
