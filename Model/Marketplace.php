...
//pr($marketPlaceResults);
        ...
        $globalData = array();
        foreach ($marketPlaceResults as $result) {
            $globalData[$result['Marketplace']['company_id']]['TotalInvestmentAmountAvailableInCompany'] = $globalData[$result['Marketplace']['company_id']]['TotalInvestmentAmountAvailableInCompany'] +
                    $result['Marketplace']['marketplace_amount'];

            $globalData[$result['Marketplace']['company_id']]['TotalInvestmentOptionsAvailableInCompany'] = $globalData[$result['Marketplace']['company_id']]['TotalInvestmentOptionsAvailableInCompany'] + 1;


            $globalData[$result['Marketplace']['company_id']]['InterestRateInCompany1'] = $globalData[$result['Marketplace']['company_id']]['InterestRateInCompany1'] + $result['Marketplace']['marketplace_interestRate'];
