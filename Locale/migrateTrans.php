...
*/
	error_reporting(2);
$inFileOld = "default_spanish.po";    					// the old po file
$inFileNew = "default.pot"; 								// the new po file
$newFile = 	"newFile20170316.po";						// the new translation table including the delta
